...
### No row variance, column variance or dyadic correlation
...
```{r, fig.cap='Example from [`amen` tutorial](https://github.com/pdhoff/amen/blob/master/inst/doc/amen.pdf)', out.width='80%', fig.asp=.75, fig.align='center',echo=FALSE,cache=TRUE}
