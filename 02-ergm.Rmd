...
```{r, fig.cap='Example from [Tutorial](https://statnet.org/trac/raw-attachment/wiki/Sunbelt2016/ergm_tutorial.html)', out.width='80%', fig.asp=.75, fig.align='center',echo=FALSE,cache=TRUE}
knitr::include_graphics("images/mcdiag.png")
```

## More functions

```{r, fig.cap='Example from [Tutorial](https://statnet.org/trac/raw-attachment/wiki/Sunbelt2016/ergm_tutorial.html)', out.width='80%', fig.asp=.75, fig.align='center',echo=FALSE,cache=TRUE}
knitr::include_graphics("images/more.png")
```
